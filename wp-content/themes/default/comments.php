...
if(have_comments()):
	?>
		<div class="comment_box">
			<div class="first_row">
				<?php echo $comments_count = get_comments_number(); ?><span class="second_row small"><?php echo ($comments_count!=1 ? __("Comments", $themename) : __("Comment", $themename)); ?></span>
			</div>
		</div>
...
?>
	<li <?php comment_class('comment clearfix'); ?> id="comment-<?php comment_ID() ?>">
		...
		<div class="comment_details">
			<div class="posted_by">
				<?php 
				_e("Posted by ", $themename); comment_author_link();
				_e(" on", $themename); 
				printf(__(' %1$s at %2$s'), get_comment_date(),  get_comment_time());
				edit_comment_link(__('(Edit)', $themename),'&nbsp;&nbsp;&nbsp;','');
				if((int)$comment->comment_parent>0)
				{
					echo '<br /><a class="show_source_comment" href="#comment-' . (int)$comment->comment_parent . '" title="' . __('Show comment', $themename) . '">';
			...
			<?php comment_text(); ?>
			<a class="icon_small_arrow right_white reply_button" href="#<?php comment_ID(); ?>" title="<?php _e('Reply', $themename); ?>">
